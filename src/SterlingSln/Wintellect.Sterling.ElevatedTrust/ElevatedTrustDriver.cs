...
namespace Wintellect.Sterling.ElevatedTrust
{
    ...
    /// </summary>
    public class ElevatedTrustDriver : BaseDriver
    {
        ...
        public ElevatedTrustDriver(string basePath) 
        {
            Initialize(basePath);
        }
       
        public ElevatedTrustDriver(string databaseName, ISterlingSerializer serializer, Action<SterlingLogLevel, string, Exception> log) : this(databaseName, serializer, log, BASE)
        {
        }
        
        public ElevatedTrustDriver(string databaseName, ISterlingSerializer serializer, Action<SterlingLogLevel, string, Exception> log, string basePath)
        ...
        public void Initialize(string basePath)
        {
            ...
            {
                throw new SterlingException("Elevated permissions are required to use the elevated trust driver.");
            }
