...
namespace Wintellect.Sterling.Server.FileSystem.Test.Database
{
    ...
    public class TestChangingTypeVersion
    {
        ...
        public void TestInit()
        {
            ...
            _firstDatabaseInstance = _firstEngine.SterlingDatabase.RegisterDatabase<ChangingTypeFirstVersionDatabase>(new FileSystemDriver());
        ...
        public void TestSaveAndLoad()
        {
            ...
            _secondDatabaseInstance = _firstEngine.SterlingDatabase.RegisterDatabase<ChangingTypeSecondVersionDatabase>(new FileSystemDriver());
