...
namespace Wintellect.Sterling.ElevatedTrust.Test.Database
{
    ...
    public class TestChangingTypeVersion
    {
        ...
        public void TestInit()
        {
            ...
            _firstDatabaseInstance = _firstEngine.SterlingDatabase.RegisterDatabase<ChangingTypeFirstVersionDatabase>(new ElevatedTrustDriver());
        ...
        public void TestSaveAndLoad()
        {
            ...
            _secondDatabaseInstance = _firstEngine.SterlingDatabase.RegisterDatabase<ChangingTypeSecondVersionDatabase>(new ElevatedTrustDriver());
